...
/**
 * Drives the real generators ADR 0029 names under the installed agent, in the fixture package, and
 * checks each class they define reaches the transformer chain and is left alone: no probes, no
 * skipped entry, and no report from the sweep. A class ByteBuddy defines under a name of the
 * adopter's own kind is registered as usual, which shows the transformer weaves generated bytes
 * when nothing turns them away.
 */
